...
teste("29. PWA offline inclui CSS, JS e imagens locais", () => ok(sw.includes("primedocs-v54")&&sw.includes("producao-premium.css")&&sw.includes("producao-premium.js")&&sw.includes("a1-mini.svg")));
