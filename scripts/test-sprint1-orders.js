...
const menu=fs.readFileSync("js/components/navigation.js","utf8");assert(menu.indexOf('"producao"')<menu.indexOf('"clientes"')&&menu.indexOf('"estoque"')<menu.indexOf('"consignado"')&&menu.indexOf('"consignado"')<menu.indexOf('"financeiro"'),"menu segue a ordem operacional do sprint com Estoque unificado");
