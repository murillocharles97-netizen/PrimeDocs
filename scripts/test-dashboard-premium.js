...
teste("38. versão visual e cache do PWA foram renovados",()=>ok(index.includes("dashboard-premium.css?v=2")&&index.includes("dashboard-premium.js?v=2")&&sw.includes("primedocs-v51")));
