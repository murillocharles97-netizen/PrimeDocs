...
teste("17. editor fica disponível offline no PWA v64", () => ok(sw.includes("primedocs-v64") && sw.includes("pedidos-editor-mobile.css") && sw.includes("pedidos-editor-mobile.js")));
